...
public class PersistedDataSurvivesTest {
   ...
   public void put_on_persisted_cache() throws Exception {
      ...
      hotRodTester.createNamedCache("custom-persisted", "persistent-file-store");
      hotRodTester.namedCachePutGetTest("custom-persisted");
   }
   ...
   public void get_on_persisted_cache() throws Exception {
      ...
      hotRodTester.namedCacheGetTest("custom-persisted");
   }
